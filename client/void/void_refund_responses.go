...
func (o *VoidRefundCreated) Error() string {
	...
	return fmt.Sprintf("[POST /pts/v2/refunds/{id}/voids][%d] voidRefundCreated %s", 201, payload)
}
...
func (o *VoidRefundBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/refunds/{id}/voids][%d] voidRefundBadRequest %s", 400, payload)
}
...
func (o *VoidRefundBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/refunds/{id}/voids][%d] voidRefundBadGateway %s", 502, payload)
}
...
type VoidRefundBody struct {
	...
	AgreementInformation *VoidRefundParamsBodyAgreementInformation `json:"agreementInformation,omitempty"`
	...
	MerchantInformation *VoidRefundParamsBodyMerchantInformation `json:"merchantInformation,omitempty"`

	// order information
	OrderInformation *VoidRefundParamsBodyOrderInformation `json:"orderInformation,omitempty"`

	// payment information
	PaymentInformation *VoidRefundParamsBodyPaymentInformation `json:"paymentInformation,omitempty"`

	// processing information
	ProcessingInformation *VoidRefundParamsBodyProcessingInformation `json:"processingInformation,omitempty"`
}
...
func (o *VoidRefundBody) validateAgreementInformation(formats strfmt.Registry) error {
	...
	if o.AgreementInformation != nil {
		if err := o.AgreementInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("voidRefundRequest" + "." + "agreementInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("voidRefundRequest" + "." + "agreementInformation")
			}
			return err
		}
	}
...
func (o *VoidRefundBody) validateMerchantInformation(formats strfmt.Registry) error {
	...
	if o.MerchantInformation != nil {
		if err := o.MerchantInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("voidRefundRequest" + "." + "merchantInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("voidRefundRequest" + "." + "merchantInformation")
			}
			return err
		}
	}
...
func (o *VoidRefundBody) validateOrderInformation(formats strfmt.Registry) error {
	...
	if o.OrderInformation != nil {
		if err := o.OrderInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("voidRefundRequest" + "." + "orderInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("voidRefundRequest" + "." + "orderInformation")
			}
			return err
		}
	}
...
func (o *VoidRefundBody) validateProcessingInformation(formats strfmt.Registry) error {
	...
	if o.ProcessingInformation != nil {
		if err := o.ProcessingInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("voidRefundRequest" + "." + "processingInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("voidRefundRequest" + "." + "processingInformation")
			}
			return err
		}
	}
...
func (o *VoidRefundBody) contextValidateAgreementInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *VoidRefundBody) contextValidateMerchantInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *VoidRefundBody) contextValidateOrderInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *VoidRefundBody) contextValidateProcessingInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *VoidRefundCreatedBody) validateReconciliationID(formats strfmt.Registry) error {
	if swag.IsZero(o.ReconciliationID) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundCreated"+"."+"reconciliationId", "body", o.ReconciliationID, 60); err != nil {
		return err
	}
...
func (o *VoidRefundCreatedBodyProcessorInformation) validateResponseDetails(formats strfmt.Registry) error {
	if swag.IsZero(o.ResponseDetails) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundCreated"+"."+"processorInformation"+"."+"responseDetails", "body", o.ResponseDetails, 60); err != nil {
		return err
	}
...
/*
VoidRefundParamsBodyAgreementInformation void refund params body agreement information
swagger:model VoidRefundParamsBodyAgreementInformation
*/
type VoidRefundParamsBodyAgreementInformation struct {
...
// Validate validates this void refund params body agreement information
func (o *VoidRefundParamsBodyAgreementInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *VoidRefundParamsBodyAgreementInformation) validateAgreementID(formats strfmt.Registry) error {
	if swag.IsZero(o.AgreementID) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"agreementInformation"+"."+"agreementId", "body", o.AgreementID, 50); err != nil {
		return err
	}
...
// ContextValidate validates this void refund params body agreement information based on context it is used
func (o *VoidRefundParamsBodyAgreementInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *VoidRefundParamsBodyAgreementInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *VoidRefundParamsBodyAgreementInformation) UnmarshalBinary(b []byte) error {
	var res VoidRefundParamsBodyAgreementInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *VoidRefundParamsBodyClientReferenceInformation) validateReconciliationID(formats strfmt.Registry) error {
	if swag.IsZero(o.ReconciliationID) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"clientReferenceInformation"+"."+"reconciliationId", "body", o.ReconciliationID, 60); err != nil {
		return err
	}
...
func (o *VoidRefundParamsBodyClientReferenceInformation) validateTransactionID(formats strfmt.Registry) error {
	if swag.IsZero(o.TransactionID) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"clientReferenceInformation"+"."+"transactionId", "body", o.TransactionID, 30); err != nil {
		return err
	}
...
/*
VoidRefundParamsBodyMerchantInformation void refund params body merchant information
swagger:model VoidRefundParamsBodyMerchantInformation
*/
type VoidRefundParamsBodyMerchantInformation struct {
...
// Validate validates this void refund params body merchant information
func (o *VoidRefundParamsBodyMerchantInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *VoidRefundParamsBodyMerchantInformation) validateTransactionLocalDateTime(formats strfmt.Registry) error {
	if swag.IsZero(o.TransactionLocalDateTime) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"merchantInformation"+"."+"transactionLocalDateTime", "body", o.TransactionLocalDateTime, 16); err != nil {
		return err
	}
...
// ContextValidate validates this void refund params body merchant information based on context it is used
func (o *VoidRefundParamsBodyMerchantInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *VoidRefundParamsBodyMerchantInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *VoidRefundParamsBodyMerchantInformation) UnmarshalBinary(b []byte) error {
	var res VoidRefundParamsBodyMerchantInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
VoidRefundParamsBodyOrderInformation void refund params body order information
swagger:model VoidRefundParamsBodyOrderInformation
*/
type VoidRefundParamsBodyOrderInformation struct {

	// amount details
	AmountDetails *VoidRefundParamsBodyOrderInformationAmountDetails `json:"amountDetails,omitempty"`
}

// Validate validates this void refund params body order information
func (o *VoidRefundParamsBodyOrderInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *VoidRefundParamsBodyOrderInformation) validateAmountDetails(formats strfmt.Registry) error {
	...
	if o.AmountDetails != nil {
		if err := o.AmountDetails.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("voidRefundRequest" + "." + "orderInformation" + "." + "amountDetails")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("voidRefundRequest" + "." + "orderInformation" + "." + "amountDetails")
			}
			return err
		}
	}
...
// ContextValidate validate this void refund params body order information based on the context it is used
func (o *VoidRefundParamsBodyOrderInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *VoidRefundParamsBodyOrderInformation) contextValidateAmountDetails(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *VoidRefundParamsBodyOrderInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *VoidRefundParamsBodyOrderInformation) UnmarshalBinary(b []byte) error {
	var res VoidRefundParamsBodyOrderInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
VoidRefundParamsBodyOrderInformationAmountDetails void refund params body order information amount details
swagger:model VoidRefundParamsBodyOrderInformationAmountDetails
*/
type VoidRefundParamsBodyOrderInformationAmountDetails struct {
...
// Validate validates this void refund params body order information amount details
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) validateCurrency(formats strfmt.Registry) error {
	if swag.IsZero(o.Currency) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"orderInformation"+"."+"amountDetails"+"."+"currency", "body", o.Currency, 3); err != nil {
		return err
	}
...
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) validateTotalAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TotalAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("voidRefundRequest"+"."+"orderInformation"+"."+"amountDetails"+"."+"totalAmount", "body", o.TotalAmount, 19); err != nil {
		return err
	}
...
// ContextValidate validates this void refund params body order information amount details based on context it is used
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *VoidRefundParamsBodyOrderInformationAmountDetails) UnmarshalBinary(b []byte) error {
	var res VoidRefundParamsBodyOrderInformationAmountDetails
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
VoidRefundParamsBodyProcessingInformation void refund params body processing information
swagger:model VoidRefundParamsBodyProcessingInformation
*/
type VoidRefundParamsBodyProcessingInformation struct {
...
// Validate validates this void refund params body processing information
func (o *VoidRefundParamsBodyProcessingInformation) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this void refund params body processing information based on context it is used
func (o *VoidRefundParamsBodyProcessingInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *VoidRefundParamsBodyProcessingInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *VoidRefundParamsBodyProcessingInformation) UnmarshalBinary(b []byte) error {
	var res VoidRefundParamsBodyProcessingInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
