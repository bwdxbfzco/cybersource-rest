...
// New creates a new user management search API client with basic auth credentials.
...
// New creates a new user management search API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
