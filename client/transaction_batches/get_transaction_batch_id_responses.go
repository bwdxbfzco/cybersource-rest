...
func (o *GetTransactionBatchIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdOK %s", 200, payload)
}
...
func (o *GetTransactionBatchIDBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdBadRequest %s", 400, payload)
}
...
func (o *GetTransactionBatchIDUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdUnauthorized %s", 401, payload)
}
...
func (o *GetTransactionBatchIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdForbidden %s", 403, payload)
}
...
func (o *GetTransactionBatchIDNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdNotFound %s", 404, payload)
}
...
func (o *GetTransactionBatchIDBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pts/v1/transaction-batches/{id}][%d] getTransactionBatchIdBadGateway %s", 502, payload)
}
