...
func (o *CreateCreditReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /pts/v2/credits] createCredit", response, response.Code())
	}
}
...
// IsSuccess returns true when this create credit created response has a 2xx status code
func (o *CreateCreditCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create credit created response has a 3xx status code
func (o *CreateCreditCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create credit created response has a 4xx status code
func (o *CreateCreditCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this create credit created response has a 5xx status code
func (o *CreateCreditCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this create credit created response a status code equal to that given
func (o *CreateCreditCreated) IsCode(code int) bool {
	return code == 201
}

// Code gets the status code for the create credit created response
func (o *CreateCreditCreated) Code() int {
	return 201
}

func (o *CreateCreditCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditCreated %s", 201, payload)
}

func (o *CreateCreditCreated) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditCreated %s", 201, payload)
}
...
// IsSuccess returns true when this create credit bad request response has a 2xx status code
func (o *CreateCreditBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create credit bad request response has a 3xx status code
func (o *CreateCreditBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create credit bad request response has a 4xx status code
func (o *CreateCreditBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this create credit bad request response has a 5xx status code
func (o *CreateCreditBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this create credit bad request response a status code equal to that given
func (o *CreateCreditBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the create credit bad request response
func (o *CreateCreditBadRequest) Code() int {
	return 400
}

func (o *CreateCreditBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditBadRequest %s", 400, payload)
}

func (o *CreateCreditBadRequest) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditBadRequest %s", 400, payload)
}
...
// IsSuccess returns true when this create credit bad gateway response has a 2xx status code
func (o *CreateCreditBadGateway) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create credit bad gateway response has a 3xx status code
func (o *CreateCreditBadGateway) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create credit bad gateway response has a 4xx status code
func (o *CreateCreditBadGateway) IsClientError() bool {
	return false
}

// IsServerError returns true when this create credit bad gateway response has a 5xx status code
func (o *CreateCreditBadGateway) IsServerError() bool {
	return true
}

// IsCode returns true when this create credit bad gateway response a status code equal to that given
func (o *CreateCreditBadGateway) IsCode(code int) bool {
	return code == 502
}

// Code gets the status code for the create credit bad gateway response
func (o *CreateCreditBadGateway) Code() int {
	return 502
}

func (o *CreateCreditBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditBadGateway %s", 502, payload)
}

func (o *CreateCreditBadGateway) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/credits][%d] createCreditBadGateway %s", 502, payload)
}
...
type CreateCreditBody struct {
	...
	MerchantDefinedSecureInformation *CreateCreditParamsBodyMerchantDefinedSecureInformation `json:"merchantDefinedSecureInformation,omitempty"`
	...
	RecipientInformation *CreateCreditParamsBodyRecipientInformation `json:"recipientInformation,omitempty"`

	// sender information
	SenderInformation *CreateCreditParamsBodySenderInformation `json:"senderInformation,omitempty"`
...
func (o *CreateCreditBody) validateMerchantDefinedSecureInformation(formats strfmt.Registry) error {
	...
	if o.MerchantDefinedSecureInformation != nil {
		if err := o.MerchantDefinedSecureInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "merchantDefinedSecureInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "merchantDefinedSecureInformation")
			}
			return err
		}
	}
...
func (o *CreateCreditBody) validateRecipientInformation(formats strfmt.Registry) error {
	...
	if o.RecipientInformation != nil {
		if err := o.RecipientInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "recipientInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "recipientInformation")
			}
			return err
		}
	}
...
func (o *CreateCreditBody) validateSenderInformation(formats strfmt.Registry) error {
	...
	if o.SenderInformation != nil {
		if err := o.SenderInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "senderInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "senderInformation")
			}
			return err
		}
	}
...
func (o *CreateCreditBody) contextValidateMerchantDefinedSecureInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CreateCreditBody) contextValidateRecipientInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CreateCreditBody) contextValidateSenderInformation(ctx context.Context, formats strfmt.Registry) error {
...
type CreateCreditCreatedBodyOrderInformation struct {
	...
	// amount details
	AmountDetails *CreateCreditCreatedBodyOrderInformationAmountDetails `json:"amountDetails,omitempty"`
...
func (o *CreateCreditCreatedBodyOrderInformation) validateAmountDetails(formats strfmt.Registry) error {
	...
	if o.AmountDetails != nil {
		if err := o.AmountDetails.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditCreated" + "." + "orderInformation" + "." + "amountDetails")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditCreated" + "." + "orderInformation" + "." + "amountDetails")
			}
			return err
		}
	}
...
func (o *CreateCreditCreatedBodyOrderInformation) contextValidateAmountDetails(ctx context.Context, formats strfmt.Registry) error {
...
/*
CreateCreditCreatedBodyOrderInformationAmountDetails create credit created body order information amount details
swagger:model CreateCreditCreatedBodyOrderInformationAmountDetails
*/
type CreateCreditCreatedBodyOrderInformationAmountDetails struct {
...
// Validate validates this create credit created body order information amount details
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) validateExchangeRate(formats strfmt.Registry) error {
	if swag.IsZero(o.ExchangeRate) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"exchangeRate", "body", o.ExchangeRate, 13); err != nil {
		return err
	}
...
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) validateForeignAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.ForeignAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"foreignAmount", "body", o.ForeignAmount, 15); err != nil {
		return err
	}
...
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) validateForeignCurrency(formats strfmt.Registry) error {
	if swag.IsZero(o.ForeignCurrency) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"foreignCurrency", "body", o.ForeignCurrency, 5); err != nil {
		return err
	}
...
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) validateSettlementAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"settlementAmount", "body", o.SettlementAmount, 12); err != nil {
		return err
	}
...
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) validateSettlementCurrency(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementCurrency) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"settlementCurrency", "body", o.SettlementCurrency, 3); err != nil {
		return err
	}
...
// ContextValidate validates this create credit created body order information amount details based on context it is used
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditCreatedBodyOrderInformationAmountDetails) UnmarshalBinary(b []byte) error {
	var res CreateCreditCreatedBodyOrderInformationAmountDetails
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateCreditCreatedBodyProcessorInformation) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateSettlementDate(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreateCreditCreatedBodyProcessorInformation) validateApprovalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ApprovalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"processorInformation"+"."+"approvalCode", "body", o.ApprovalCode, 6); err != nil {
		return err
	}
...
func (o *CreateCreditCreatedBodyProcessorInformation) validateSettlementDate(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementDate) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditCreated"+"."+"processorInformation"+"."+"settlementDate", "body", o.SettlementDate, 4); err != nil {
		return err
	}
...
type CreateCreditParamsBodyBuyerInformation struct {
	...
	PersonalIdentification []*CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0 `json:"personalIdentification"`
...
func (o *CreateCreditParamsBodyBuyerInformation) validateDateOfBirth(formats strfmt.Registry) error {
	if swag.IsZero(o.DateOfBirth) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"buyerInformation"+"."+"dateOfBirth", "body", o.DateOfBirth, 8); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyBuyerInformation) validateGender(formats strfmt.Registry) error {
	if swag.IsZero(o.Gender) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"buyerInformation"+"."+"gender", "body", o.Gender, 3); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyBuyerInformation) validateLanguage(formats strfmt.Registry) error {
	if swag.IsZero(o.Language) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"buyerInformation"+"."+"language", "body", o.Language, 2); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyBuyerInformation) validatePersonalIdentification(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.PersonalIdentification); i++ {
		...
		if o.PersonalIdentification[i] != nil {
			if err := o.PersonalIdentification[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("createCreditRequest" + "." + "buyerInformation" + "." + "personalIdentification" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("createCreditRequest" + "." + "buyerInformation" + "." + "personalIdentification" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this create credit params body buyer information based on the context it is used
...
func (o *CreateCreditParamsBodyBuyerInformation) contextValidatePersonalIdentification(ctx context.Context, formats strfmt.Registry) error {
...
/*
CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0 create credit params body buyer information personal identification items0
swagger:model CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0
*/
type CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0 struct {
...
// Validate validates this create credit params body buyer information personal identification items0
func (o *CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0) validateID(formats strfmt.Registry) error {
	if swag.IsZero(o.ID) { // not required
		return nil
	}
...
// ContextValidate validates this create credit params body buyer information personal identification items0 based on context it is used
func (o *CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyBuyerInformationPersonalIdentificationItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateCreditParamsBodyClientReferenceInformation) validateReconciliationID(formats strfmt.Registry) error {
	if swag.IsZero(o.ReconciliationID) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"clientReferenceInformation"+"."+"reconciliationId", "body", o.ReconciliationID, 60); err != nil {
		return err
	}
...
/*
CreateCreditParamsBodyMerchantDefinedSecureInformation The object containing the secure data that the merchant defines.
//
swagger:model CreateCreditParamsBodyMerchantDefinedSecureInformation
*/
type CreateCreditParamsBodyMerchantDefinedSecureInformation struct {
...
// Validate validates this create credit params body merchant defined secure information
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) validateSecure1(formats strfmt.Registry) error {
	if swag.IsZero(o.Secure1) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantDefinedSecureInformation"+"."+"secure1", "body", o.Secure1, 2048); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) validateSecure2(formats strfmt.Registry) error {
	if swag.IsZero(o.Secure2) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantDefinedSecureInformation"+"."+"secure2", "body", o.Secure2, 2048); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) validateSecure3(formats strfmt.Registry) error {
	if swag.IsZero(o.Secure3) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantDefinedSecureInformation"+"."+"secure3", "body", o.Secure3, 2048); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) validateSecure4(formats strfmt.Registry) error {
	if swag.IsZero(o.Secure4) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantDefinedSecureInformation"+"."+"secure4", "body", o.Secure4, 2048); err != nil {
		return err
	}
...
// ContextValidate validates this create credit params body merchant defined secure information based on context it is used
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyMerchantDefinedSecureInformation) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyMerchantDefinedSecureInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateCreditParamsBodyMerchantInformationMerchantDescriptor) validateCountryOfOrigin(formats strfmt.Registry) error {
	if swag.IsZero(o.CountryOfOrigin) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"countryOfOrigin", "body", o.CountryOfOrigin, 2); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantInformationMerchantDescriptor) validateCustomerServicePhoneNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.CustomerServicePhoneNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"customerServicePhoneNumber", "body", o.CustomerServicePhoneNumber, 27); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantInformationMerchantDescriptor) validateStoreID(formats strfmt.Registry) error {
	if swag.IsZero(o.StoreID) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"storeId", "body", o.StoreID, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyMerchantInformationMerchantDescriptor) validateStoreName(formats strfmt.Registry) error {
	if swag.IsZero(o.StoreName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"storeName", "body", o.StoreName, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationBillTo) validateCounty(formats strfmt.Registry) error {
	if swag.IsZero(o.County) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"billTo"+"."+"county", "body", o.County, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationBillTo) validateDistrict(formats strfmt.Registry) error {
	if swag.IsZero(o.District) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"billTo"+"."+"district", "body", o.District, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationBillTo) validateMiddleName(formats strfmt.Registry) error {
	if swag.IsZero(o.MiddleName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"billTo"+"."+"middleName", "body", o.MiddleName, 60); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationBillTo) validateTitle(formats strfmt.Registry) error {
	if swag.IsZero(o.Title) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"billTo"+"."+"title", "body", o.Title, 60); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationShipTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"administrativeArea", "body", o.AdministrativeArea, 20); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationShipTo) validateCounty(formats strfmt.Registry) error {
	if swag.IsZero(o.County) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"county", "body", o.County, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyOrderInformationShipTo) validateEmail(formats strfmt.Registry) error {
	if swag.IsZero(o.Email) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"email", "body", o.Email, 255); err != nil {
		return err
	}
...
type CreateCreditParamsBodyPaymentInformation struct {
	...
	// e wallet
	EWallet *CreateCreditParamsBodyPaymentInformationEWallet `json:"eWallet,omitempty"`
...
func (o *CreateCreditParamsBodyPaymentInformation) validateEWallet(formats strfmt.Registry) error {
	...
	if o.EWallet != nil {
		if err := o.EWallet.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "paymentInformation" + "." + "eWallet")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "paymentInformation" + "." + "eWallet")
			}
			return err
		}
	}
...
func (o *CreateCreditParamsBodyPaymentInformation) contextValidateEWallet(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CreateCreditParamsBodyPaymentInformationCard) validateSecurityCode(formats strfmt.Registry) error {
	if swag.IsZero(o.SecurityCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"card"+"."+"securityCode", "body", o.SecurityCode, 4); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPaymentInformationCard) validateUseAs(formats strfmt.Registry) error {
	if swag.IsZero(o.UseAs) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"card"+"."+"useAs", "body", o.UseAs, 20); err != nil {
		return err
	}
...
/*
CreateCreditParamsBodyPaymentInformationEWallet create credit params body payment information e wallet
swagger:model CreateCreditParamsBodyPaymentInformationEWallet
*/
type CreateCreditParamsBodyPaymentInformationEWallet struct {
...
// Validate validates this create credit params body payment information e wallet
func (o *CreateCreditParamsBodyPaymentInformationEWallet) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodyPaymentInformationEWallet) validateFundingSource(formats strfmt.Registry) error {
	if swag.IsZero(o.FundingSource) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"eWallet"+"."+"fundingSource", "body", o.FundingSource, 30); err != nil {
		return err
	}
...
// ContextValidate validates this create credit params body payment information e wallet based on context it is used
func (o *CreateCreditParamsBodyPaymentInformationEWallet) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyPaymentInformationEWallet) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyPaymentInformationEWallet) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyPaymentInformationEWallet
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateCreditParamsBodyPaymentInformationFluidData) validateValue(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"fluidData"+"."+"value", "body", o.Value, 4000); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPaymentInformationLegacyToken) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("createCreditRequest"+"."+"paymentInformation"+"."+"legacyToken"+"."+"id", "body", o.ID, 1); err != nil {
		return err
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"legacyToken"+"."+"id", "body", o.ID, 32); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPaymentInformationTokenizedCard) validateAssuranceMethod(formats strfmt.Registry) error {
	if swag.IsZero(o.AssuranceMethod) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"assuranceMethod", "body", o.AssuranceMethod, 2); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPaymentInformationTokenizedCard) validateCryptogram(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"cryptogram", "body", o.Cryptogram, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPaymentInformationTokenizedCard) validateSecurityCodeIndicator(formats strfmt.Registry) error {
	if swag.IsZero(o.SecurityCodeIndicator) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"securityCodeIndicator", "body", o.SecurityCodeIndicator, 1); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyPointOfSaleInformation) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateServiceCode(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreateCreditParamsBodyPointOfSaleInformation) validateServiceCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ServiceCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"pointOfSaleInformation"+"."+"serviceCode", "body", o.ServiceCode, 3); err != nil {
		return err
	}
...
type CreateCreditParamsBodyProcessingInformation struct {
	...
	// refund options
	RefundOptions *CreateCreditParamsBodyProcessingInformationRefundOptions `json:"refundOptions,omitempty"`
...
func (o *CreateCreditParamsBodyProcessingInformation) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateRefundOptions(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreateCreditParamsBodyProcessingInformation) validateRefundOptions(formats strfmt.Registry) error {
	if swag.IsZero(o.RefundOptions) { // not required
		return nil
	}

	if o.RefundOptions != nil {
		if err := o.RefundOptions.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "processingInformation" + "." + "refundOptions")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "processingInformation" + "." + "refundOptions")
			}
			return err
		}
	}
...
func (o *CreateCreditParamsBodyProcessingInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateRefundOptions(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreateCreditParamsBodyProcessingInformation) contextValidateRefundOptions(ctx context.Context, formats strfmt.Registry) error {
	...
	if o.RefundOptions != nil {
		...
		if err := o.RefundOptions.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "processingInformation" + "." + "refundOptions")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "processingInformation" + "." + "refundOptions")
...
func (o *CreateCreditParamsBodyProcessingInformationJapanPaymentOptions) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateInstallments(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreateCreditParamsBodyProcessingInformationJapanPaymentOptions) validateInstallments(formats strfmt.Registry) error {
	if swag.IsZero(o.Installments) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"processingInformation"+"."+"japanPaymentOptions"+"."+"installments", "body", o.Installments, 99); err != nil {
		return err
	}
...
/*
CreateCreditParamsBodyProcessingInformationRefundOptions create credit params body processing information refund options
swagger:model CreateCreditParamsBodyProcessingInformationRefundOptions
*/
type CreateCreditParamsBodyProcessingInformationRefundOptions struct {

	// Must be set to `pow` for Mastercard Gaming Payment of Winnings tranactions.
	Reason string `json:"reason,omitempty"`
}

// Validate validates this create credit params body processing information refund options
func (o *CreateCreditParamsBodyProcessingInformationRefundOptions) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this create credit params body processing information refund options based on context it is used
func (o *CreateCreditParamsBodyProcessingInformationRefundOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyProcessingInformationRefundOptions) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyProcessingInformationRefundOptions) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyProcessingInformationRefundOptions
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
CreateCreditParamsBodyRecipientInformation create credit params body recipient information
swagger:model CreateCreditParamsBodyRecipientInformation
*/
type CreateCreditParamsBodyRecipientInformation struct {
...
// Validate validates this create credit params body recipient information
func (o *CreateCreditParamsBodyRecipientInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodyRecipientInformation) validateFirstName(formats strfmt.Registry) error {
	if swag.IsZero(o.FirstName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"recipientInformation"+"."+"firstName", "body", o.FirstName, 35); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyRecipientInformation) validateLastName(formats strfmt.Registry) error {
	if swag.IsZero(o.LastName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"recipientInformation"+"."+"lastName", "body", o.LastName, 35); err != nil {
		return err
	}
...
// ContextValidate validates this create credit params body recipient information based on context it is used
func (o *CreateCreditParamsBodyRecipientInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyRecipientInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyRecipientInformation) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyRecipientInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
CreateCreditParamsBodySenderInformation create credit params body sender information
swagger:model CreateCreditParamsBodySenderInformation
*/
type CreateCreditParamsBodySenderInformation struct {

	// account
	Account *CreateCreditParamsBodySenderInformationAccount `json:"account,omitempty"`
...
// Validate validates this create credit params body sender information
func (o *CreateCreditParamsBodySenderInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodySenderInformation) validateAccount(formats strfmt.Registry) error {
	if swag.IsZero(o.Account) { // not required
		return nil
	}
	...
	if o.Account != nil {
		if err := o.Account.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "senderInformation" + "." + "account")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "senderInformation" + "." + "account")
			}
			return err
		}
	}
...
func (o *CreateCreditParamsBodySenderInformation) validateAddress1(formats strfmt.Registry) error {
	if swag.IsZero(o.Address1) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"address1", "body", o.Address1, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodySenderInformation) validateCountryCode(formats strfmt.Registry) error {
	if swag.IsZero(o.CountryCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"countryCode", "body", o.CountryCode, 3); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodySenderInformation) validateFirstName(formats strfmt.Registry) error {
	if swag.IsZero(o.FirstName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"firstName", "body", o.FirstName, 35); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodySenderInformation) validateLastName(formats strfmt.Registry) error {
	if swag.IsZero(o.LastName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"lastName", "body", o.LastName, 35); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodySenderInformation) validateLocality(formats strfmt.Registry) error {
	if swag.IsZero(o.Locality) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"locality", "body", o.Locality, 25); err != nil {
		return err
	}
...
// ContextValidate validate this create credit params body sender information based on the context it is used
func (o *CreateCreditParamsBodySenderInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodySenderInformation) contextValidateAccount(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *CreateCreditParamsBodySenderInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodySenderInformation) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodySenderInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
CreateCreditParamsBodySenderInformationAccount create credit params body sender information account
swagger:model CreateCreditParamsBodySenderInformationAccount
*/
type CreateCreditParamsBodySenderInformationAccount struct {
...
// Validate validates this create credit params body sender information account
func (o *CreateCreditParamsBodySenderInformationAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodySenderInformationAccount) validateFundsSource(formats strfmt.Registry) error {
	if swag.IsZero(o.FundsSource) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"account"+"."+"fundsSource", "body", o.FundsSource, 2); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodySenderInformationAccount) validateNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.Number) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"senderInformation"+"."+"account"+"."+"number", "body", o.Number, 50); err != nil {
		return err
	}
...
// ContextValidate validates this create credit params body sender information account based on context it is used
func (o *CreateCreditParamsBodySenderInformationAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodySenderInformationAccount) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodySenderInformationAccount) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodySenderInformationAccount
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
type CreateCreditParamsBodyTravelInformation struct {
	...
	// vehicle data
	VehicleData *CreateCreditParamsBodyTravelInformationVehicleData `json:"vehicleData,omitempty"`
}
...
func (o *CreateCreditParamsBodyTravelInformation) validateVehicleData(formats strfmt.Registry) error {
	...
	if o.VehicleData != nil {
		if err := o.VehicleData.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createCreditRequest" + "." + "travelInformation" + "." + "vehicleData")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createCreditRequest" + "." + "travelInformation" + "." + "vehicleData")
			}
			return err
		}
	}
...
func (o *CreateCreditParamsBodyTravelInformation) contextValidateVehicleData(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CreateCreditParamsBodyTravelInformationAutoRental) validateAffiliateName(formats strfmt.Registry) error {
	if swag.IsZero(o.AffiliateName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"affiliateName", "body", o.AffiliateName, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationAutoRental) validateCompanyName(formats strfmt.Registry) error {
	if swag.IsZero(o.CompanyName) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"companyName", "body", o.CompanyName, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationAutoRentalRentalAddress) validatePostalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.PostalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"rentalAddress"+"."+"postalCode", "body", o.PostalCode, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationAutoRentalReturnAddress) validateAddress1(formats strfmt.Registry) error {
	if swag.IsZero(o.Address1) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"returnAddress"+"."+"address1", "body", o.Address1, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationAutoRentalReturnAddress) validatePostalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.PostalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"returnAddress"+"."+"postalCode", "body", o.PostalCode, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationLodging) validateName(formats strfmt.Registry) error {
	if swag.IsZero(o.Name) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"lodging"+"."+"name", "body", o.Name, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateFlightType(formats strfmt.Registry) error {
	if swag.IsZero(o.FlightType) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"flightType", "body", o.FlightType, 2); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateFrequentFlyerNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.FrequentFlyerNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"frequentFlyerNumber", "body", o.FrequentFlyerNumber, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateInsuranceAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.InsuranceAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"insuranceAmount", "body", o.InsuranceAmount, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateIsDomestic(formats strfmt.Registry) error {
	if swag.IsZero(o.IsDomestic) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"isDomestic", "body", o.IsDomestic, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validatePassengerType(formats strfmt.Registry) error {
	if swag.IsZero(o.PassengerType) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"passengerType", "body", o.PassengerType, 50); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateReservationSystemCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"reservationSystemCode", "body", o.ReservationSystemCode, 20); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateThirdPartyStatus(formats strfmt.Registry) error {
	if swag.IsZero(o.ThirdPartyStatus) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"thirdPartyStatus", "body", o.ThirdPartyStatus, 255); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationTransitAirline) validateTotalInsuranceAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TotalInsuranceAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"totalInsuranceAmount", "body", o.TotalInsuranceAmount, 50); err != nil {
		return err
	}
...
/*
CreateCreditParamsBodyTravelInformationVehicleData create credit params body travel information vehicle data
swagger:model CreateCreditParamsBodyTravelInformationVehicleData
*/
type CreateCreditParamsBodyTravelInformationVehicleData struct {
...
// Validate validates this create credit params body travel information vehicle data
func (o *CreateCreditParamsBodyTravelInformationVehicleData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateCreditParamsBodyTravelInformationVehicleData) validateChargingReasonCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ChargingReasonCode) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"vehicleData"+"."+"chargingReasonCode", "body", o.ChargingReasonCode, 3); err != nil {
		return err
	}
...
func (o *CreateCreditParamsBodyTravelInformationVehicleData) validateConnectorType(formats strfmt.Registry) error {
	if swag.IsZero(o.ConnectorType) { // not required
		return nil
	}

	if err := validate.MaxLength("createCreditRequest"+"."+"travelInformation"+"."+"vehicleData"+"."+"connectorType", "body", o.ConnectorType, 3); err != nil {
		return err
	}
...
// ContextValidate validates this create credit params body travel information vehicle data based on context it is used
func (o *CreateCreditParamsBodyTravelInformationVehicleData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateCreditParamsBodyTravelInformationVehicleData) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateCreditParamsBodyTravelInformationVehicleData) UnmarshalBinary(b []byte) error {
	var res CreateCreditParamsBodyTravelInformationVehicleData
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
