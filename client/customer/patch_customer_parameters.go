...
// WithCustomerID adds the customerID to the patch customer params
func (o *PatchCustomerParams) WithCustomerID(customerID string) *PatchCustomerParams {
	o.SetCustomerID(customerID)
	return o
}

// SetCustomerID adds the customerId to the patch customer params
func (o *PatchCustomerParams) SetCustomerID(customerID string) {
