...
func (o *GetReportByReportIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /reporting/v3/reports/{reportId}][%d] getReportByReportIdOK %s", 200, payload)
}
...
func (o *GetReportByReportIDBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/reports/{reportId}][%d] getReportByReportIdBadRequest %s", 400, payload)
}
