...
func (o *CheckPayerAuthEnrollmentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /risk/v1/authentications] checkPayerAuthEnrollment", response, response.Code())
	}
}
...
// IsSuccess returns true when this check payer auth enrollment created response has a 2xx status code
func (o *CheckPayerAuthEnrollmentCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this check payer auth enrollment created response has a 3xx status code
func (o *CheckPayerAuthEnrollmentCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this check payer auth enrollment created response has a 4xx status code
func (o *CheckPayerAuthEnrollmentCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this check payer auth enrollment created response has a 5xx status code
func (o *CheckPayerAuthEnrollmentCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this check payer auth enrollment created response a status code equal to that given
func (o *CheckPayerAuthEnrollmentCreated) IsCode(code int) bool {
	return code == 201
}

// Code gets the status code for the check payer auth enrollment created response
func (o *CheckPayerAuthEnrollmentCreated) Code() int {
	return 201
}

func (o *CheckPayerAuthEnrollmentCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentCreated %s", 201, payload)
}

func (o *CheckPayerAuthEnrollmentCreated) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentCreated %s", 201, payload)
}
...
// IsSuccess returns true when this check payer auth enrollment bad request response has a 2xx status code
func (o *CheckPayerAuthEnrollmentBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this check payer auth enrollment bad request response has a 3xx status code
func (o *CheckPayerAuthEnrollmentBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this check payer auth enrollment bad request response has a 4xx status code
func (o *CheckPayerAuthEnrollmentBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this check payer auth enrollment bad request response has a 5xx status code
func (o *CheckPayerAuthEnrollmentBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this check payer auth enrollment bad request response a status code equal to that given
func (o *CheckPayerAuthEnrollmentBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the check payer auth enrollment bad request response
func (o *CheckPayerAuthEnrollmentBadRequest) Code() int {
	return 400
}

func (o *CheckPayerAuthEnrollmentBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentBadRequest %s", 400, payload)
}

func (o *CheckPayerAuthEnrollmentBadRequest) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentBadRequest %s", 400, payload)
}
...
// IsSuccess returns true when this check payer auth enrollment bad gateway response has a 2xx status code
func (o *CheckPayerAuthEnrollmentBadGateway) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this check payer auth enrollment bad gateway response has a 3xx status code
func (o *CheckPayerAuthEnrollmentBadGateway) IsRedirect() bool {
	return false
}

// IsClientError returns true when this check payer auth enrollment bad gateway response has a 4xx status code
func (o *CheckPayerAuthEnrollmentBadGateway) IsClientError() bool {
	return false
}

// IsServerError returns true when this check payer auth enrollment bad gateway response has a 5xx status code
func (o *CheckPayerAuthEnrollmentBadGateway) IsServerError() bool {
	return true
}

// IsCode returns true when this check payer auth enrollment bad gateway response a status code equal to that given
func (o *CheckPayerAuthEnrollmentBadGateway) IsCode(code int) bool {
	return code == 502
}

// Code gets the status code for the check payer auth enrollment bad gateway response
func (o *CheckPayerAuthEnrollmentBadGateway) Code() int {
	return 502
}

func (o *CheckPayerAuthEnrollmentBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentBadGateway %s", 502, payload)
}

func (o *CheckPayerAuthEnrollmentBadGateway) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /risk/v1/authentications][%d] checkPayerAuthEnrollmentBadGateway %s", 502, payload)
}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateAcsReferenceNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.AcsReferenceNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"acsReferenceNumber", "body", o.AcsReferenceNumber, 50); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateAuthenticationTransactionContextID(formats strfmt.Registry) error {
	if swag.IsZero(o.AuthenticationTransactionContextID) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"authenticationTransactionContextId", "body", o.AuthenticationTransactionContextID, 30); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateAuthenticationTransactionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"authenticationTransactionId", "body", o.AuthenticationTransactionID, 26); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateAuthenticationType(formats strfmt.Registry) error {
	if swag.IsZero(o.AuthenticationType) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"authenticationType", "body", o.AuthenticationType, 2); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateIdciDecision(formats strfmt.Registry) error {
	if swag.IsZero(o.IdciDecision) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"idciDecision", "body", o.IdciDecision, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateIdciReasonCode1(formats strfmt.Registry) error {
	if swag.IsZero(o.IdciReasonCode1) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"idciReasonCode1", "body", o.IdciReasonCode1, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateIdciReasonCode2(formats strfmt.Registry) error {
	if swag.IsZero(o.IdciReasonCode2) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"idciReasonCode2", "body", o.IdciReasonCode2, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyConsumerAuthenticationInformation) validateAuthenticationTransactionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"consumerAuthenticationInformation"+"."+"authenticationTransactionId", "body", o.AuthenticationTransactionID, 26); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationBillTo) validateAddress3(formats strfmt.Registry) error {
	if swag.IsZero(o.Address3) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"orderInformation"+"."+"billTo"+"."+"address3", "body", o.Address3, 60); err != nil {
		return err
	}
...
type CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0 struct {
	...
	// Max Length: 20
	ShippingMiddleName string `json:"shippingMiddleName,omitempty"`

	// Phone number where item will be shipped
	ShippingPhone int64 `json:"shippingPhone,omitempty"`

	// Postal code where item will be shipped
	ShippingPostalCode int64 `json:"shippingPostalCode,omitempty"`
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateShippingAddress1(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingAddress2(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingCity(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingCountryCode(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateShippingFirstName(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingLastName(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingMiddleName(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateShippingState(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingAddress1(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingAddress1) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingAddress1", "body", o.ShippingAddress1, 50); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingAddress2(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingAddress2) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingAddress2", "body", o.ShippingAddress2, 50); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingCity(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingCity) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingCity", "body", o.ShippingCity, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingCountryCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingCountryCode) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingCountryCode", "body", o.ShippingCountryCode, 10); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingFirstName(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingFirstName) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingFirstName", "body", o.ShippingFirstName, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingLastName(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingLastName) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingLastName", "body", o.ShippingLastName, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingMiddleName(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingMiddleName) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingMiddleName", "body", o.ShippingMiddleName, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationLineItemsItems0) validateShippingState(formats strfmt.Registry) error {
	if swag.IsZero(o.ShippingState) { // not required
		return nil
	}

	if err := validate.MaxLength("shippingState", "body", o.ShippingState, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationShipTo) validateAddress3(formats strfmt.Registry) error {
	if swag.IsZero(o.Address3) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"address3", "body", o.Address3, 60); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationShipTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"administrativeArea", "body", o.AdministrativeArea, 20); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyOrderInformationShipTo) validateMiddleName(formats strfmt.Registry) error {
	if swag.IsZero(o.MiddleName) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"middleName", "body", o.MiddleName, 60); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyPaymentInformationFluidData) validateValue(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"fluidData"+"."+"value", "body", *o.Value, 4000); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyPaymentInformationTokenizedCard) validateCryptogram(formats strfmt.Registry) error {

	if err := validate.Required("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"cryptogram", "body", o.Cryptogram); err != nil {
		return err
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"cryptogram", "body", *o.Cryptogram, 255); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyPaymentInformationTokenizedCard) validateSecurityCode(formats strfmt.Registry) error {

	if err := validate.Required("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"securityCode", "body", o.SecurityCode); err != nil {
		return err
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"securityCode", "body", *o.SecurityCode, 4); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyPaymentInformationTokenizedCard) validateTransactionType(formats strfmt.Registry) error {

	if err := validate.Required("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"transactionType", "body", o.TransactionType); err != nil {
		return err
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"transactionType", "body", *o.TransactionType, 1); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateAmountType(formats strfmt.Registry) error {
	if swag.IsZero(o.AmountType) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"amountType", "body", o.AmountType, 1); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateMaximumAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.MaximumAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"maximumAmount", "body", o.MaximumAmount, 12); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateOccurrence(formats strfmt.Registry) error {
	if swag.IsZero(o.Occurrence) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"occurrence", "body", o.Occurrence, 2); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateReferenceNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.ReferenceNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"referenceNumber", "body", o.ReferenceNumber, 35); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateType(formats strfmt.Registry) error {
	if swag.IsZero(o.Type) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"type", "body", o.Type, 1); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyRecurringPaymentInformation) validateValidationIndicator(formats strfmt.Registry) error {
	if swag.IsZero(o.ValidationIndicator) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"recurringPaymentInformation"+"."+"validationIndicator", "body", o.ValidationIndicator, 1); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyTokenInformation) validateJti(formats strfmt.Registry) error {
	if swag.IsZero(o.Jti) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"tokenInformation"+"."+"jti", "body", o.Jti, 64); err != nil {
		return err
	}
