...
CheckPayerAuthEnrollmentParams contains all the parameters to send to the API endpoint
	...
	for the check payer auth enrollment operation.
...
// WithDefaults hydrates default values in the check payer auth enrollment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CheckPayerAuthEnrollmentParams) WithDefaults() *CheckPayerAuthEnrollmentParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the check payer auth enrollment params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CheckPayerAuthEnrollmentParams) SetDefaults() {
