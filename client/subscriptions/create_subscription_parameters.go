...
type CreateSubscriptionParams struct {
	...
	CreateSubscriptionRequest CreateSubscriptionBody
...
// WithCreateSubscriptionRequest adds the createSubscriptionRequest to the create subscription params
func (o *CreateSubscriptionParams) WithCreateSubscriptionRequest(createSubscriptionRequest CreateSubscriptionBody) *CreateSubscriptionParams {
	o.SetCreateSubscriptionRequest(createSubscriptionRequest)
	return o
}

// SetCreateSubscriptionRequest adds the createSubscriptionRequest to the create subscription params
func (o *CreateSubscriptionParams) SetCreateSubscriptionRequest(createSubscriptionRequest CreateSubscriptionBody) {
	o.CreateSubscriptionRequest = createSubscriptionRequest
}
...
func (o *CreateSubscriptionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if err := r.SetBodyParam(o.CreateSubscriptionRequest); err != nil {
		return err
	}
