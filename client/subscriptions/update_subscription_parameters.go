...
type UpdateSubscriptionParams struct {
	...
	/* UpdateSubscription.
	   ...
	   Update Subscription
	*/
	UpdateSubscription UpdateSubscriptionBody
...
// WithUpdateSubscription adds the updateSubscription to the update subscription params
func (o *UpdateSubscriptionParams) WithUpdateSubscription(updateSubscription UpdateSubscriptionBody) *UpdateSubscriptionParams {
	o.SetUpdateSubscription(updateSubscription)
	return o
}

// SetUpdateSubscription adds the updateSubscription to the update subscription params
func (o *UpdateSubscriptionParams) SetUpdateSubscription(updateSubscription UpdateSubscriptionBody) {
	o.UpdateSubscription = updateSubscription
}
...
func (o *UpdateSubscriptionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if err := r.SetBodyParam(o.UpdateSubscription); err != nil {
		return err
	}
