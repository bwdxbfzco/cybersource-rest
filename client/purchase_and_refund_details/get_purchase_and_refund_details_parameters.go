...
GetPurchaseAndRefundDetailsParams contains all the parameters to send to the API endpoint
	...
	for the get purchase and refund details operation.
...
// WithDefaults hydrates default values in the get purchase and refund details params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPurchaseAndRefundDetailsParams) WithDefaults() *GetPurchaseAndRefundDetailsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get purchase and refund details params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPurchaseAndRefundDetailsParams) SetDefaults() {
	var (
	...
	val := GetPurchaseAndRefundDetailsParams{
		Limit:          &limitDefault,
