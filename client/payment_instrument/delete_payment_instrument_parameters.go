...
// WithPaymentInstrumentID adds the paymentInstrumentID to the delete payment instrument params
func (o *DeletePaymentInstrumentParams) WithPaymentInstrumentID(paymentInstrumentID string) *DeletePaymentInstrumentParams {
	o.SetPaymentInstrumentID(paymentInstrumentID)
	return o
}

// SetPaymentInstrumentID adds the paymentInstrumentId to the delete payment instrument params
func (o *DeletePaymentInstrumentParams) SetPaymentInstrumentID(paymentInstrumentID string) {
