...
// WithPaymentInstrumentID adds the paymentInstrumentID to the get payment instrument params
func (o *GetPaymentInstrumentParams) WithPaymentInstrumentID(paymentInstrumentID string) *GetPaymentInstrumentParams {
	o.SetPaymentInstrumentID(paymentInstrumentID)
	return o
}

// SetPaymentInstrumentID adds the paymentInstrumentId to the get payment instrument params
func (o *GetPaymentInstrumentParams) SetPaymentInstrumentID(paymentInstrumentID string) {
