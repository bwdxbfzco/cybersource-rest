...
func (o *PostPaymentInstrumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	case 409:
		result := NewPostPaymentInstrumentConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /tms/v1/paymentinstruments] postPaymentInstrument", response, response.Code())
	}
}
...
// IsSuccess returns true when this post payment instrument created response has a 2xx status code
func (o *PostPaymentInstrumentCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this post payment instrument created response has a 3xx status code
func (o *PostPaymentInstrumentCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument created response has a 4xx status code
func (o *PostPaymentInstrumentCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this post payment instrument created response has a 5xx status code
func (o *PostPaymentInstrumentCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this post payment instrument created response a status code equal to that given
func (o *PostPaymentInstrumentCreated) IsCode(code int) bool {
	return code == 201
}

// Code gets the status code for the post payment instrument created response
func (o *PostPaymentInstrumentCreated) Code() int {
	return 201
}

func (o *PostPaymentInstrumentCreated) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentCreated %s", 201, payload)
}

func (o *PostPaymentInstrumentCreated) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentCreated %s", 201, payload)
}
...
// IsSuccess returns true when this post payment instrument bad request response has a 2xx status code
func (o *PostPaymentInstrumentBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post payment instrument bad request response has a 3xx status code
func (o *PostPaymentInstrumentBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument bad request response has a 4xx status code
func (o *PostPaymentInstrumentBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this post payment instrument bad request response has a 5xx status code
func (o *PostPaymentInstrumentBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this post payment instrument bad request response a status code equal to that given
func (o *PostPaymentInstrumentBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the post payment instrument bad request response
func (o *PostPaymentInstrumentBadRequest) Code() int {
	return 400
}

func (o *PostPaymentInstrumentBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentBadRequest %s", 400, payload)
}

func (o *PostPaymentInstrumentBadRequest) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentBadRequest %s", 400, payload)
}
...
// IsSuccess returns true when this post payment instrument forbidden response has a 2xx status code
func (o *PostPaymentInstrumentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post payment instrument forbidden response has a 3xx status code
func (o *PostPaymentInstrumentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument forbidden response has a 4xx status code
func (o *PostPaymentInstrumentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this post payment instrument forbidden response has a 5xx status code
func (o *PostPaymentInstrumentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this post payment instrument forbidden response a status code equal to that given
func (o *PostPaymentInstrumentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the post payment instrument forbidden response
func (o *PostPaymentInstrumentForbidden) Code() int {
	return 403
}

func (o *PostPaymentInstrumentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentForbidden %s", 403, payload)
}

func (o *PostPaymentInstrumentForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentForbidden %s", 403, payload)
}
...
// NewPostPaymentInstrumentConflict creates a PostPaymentInstrumentConflict with default headers values
func NewPostPaymentInstrumentConflict() *PostPaymentInstrumentConflict {
	return &PostPaymentInstrumentConflict{}
}

/*
PostPaymentInstrumentConflict describes a response with status code 409, with default header values.

Conflict. The token is linked to a Payment Instrument.
*/
type PostPaymentInstrumentConflict struct {
	...
	Payload *PostPaymentInstrumentConflictBody
}

// IsSuccess returns true when this post payment instrument conflict response has a 2xx status code
func (o *PostPaymentInstrumentConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post payment instrument conflict response has a 3xx status code
func (o *PostPaymentInstrumentConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument conflict response has a 4xx status code
func (o *PostPaymentInstrumentConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this post payment instrument conflict response has a 5xx status code
func (o *PostPaymentInstrumentConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this post payment instrument conflict response a status code equal to that given
func (o *PostPaymentInstrumentConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the post payment instrument conflict response
func (o *PostPaymentInstrumentConflict) Code() int {
	return 409
}

func (o *PostPaymentInstrumentConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentConflict %s", 409, payload)
}

func (o *PostPaymentInstrumentConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentConflict %s", 409, payload)
}

func (o *PostPaymentInstrumentConflict) GetPayload() *PostPaymentInstrumentConflictBody {
	return o.Payload
}

func (o *PostPaymentInstrumentConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(PostPaymentInstrumentConflictBody)
...
// IsSuccess returns true when this post payment instrument failed dependency response has a 2xx status code
func (o *PostPaymentInstrumentFailedDependency) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post payment instrument failed dependency response has a 3xx status code
func (o *PostPaymentInstrumentFailedDependency) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument failed dependency response has a 4xx status code
func (o *PostPaymentInstrumentFailedDependency) IsClientError() bool {
	return true
}

// IsServerError returns true when this post payment instrument failed dependency response has a 5xx status code
func (o *PostPaymentInstrumentFailedDependency) IsServerError() bool {
	return false
}

// IsCode returns true when this post payment instrument failed dependency response a status code equal to that given
func (o *PostPaymentInstrumentFailedDependency) IsCode(code int) bool {
	return code == 424
}

// Code gets the status code for the post payment instrument failed dependency response
func (o *PostPaymentInstrumentFailedDependency) Code() int {
	return 424
}

func (o *PostPaymentInstrumentFailedDependency) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentFailedDependency %s", 424, payload)
}

func (o *PostPaymentInstrumentFailedDependency) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentFailedDependency %s", 424, payload)
}
...
// IsSuccess returns true when this post payment instrument internal server error response has a 2xx status code
func (o *PostPaymentInstrumentInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post payment instrument internal server error response has a 3xx status code
func (o *PostPaymentInstrumentInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post payment instrument internal server error response has a 4xx status code
func (o *PostPaymentInstrumentInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this post payment instrument internal server error response has a 5xx status code
func (o *PostPaymentInstrumentInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this post payment instrument internal server error response a status code equal to that given
func (o *PostPaymentInstrumentInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the post payment instrument internal server error response
func (o *PostPaymentInstrumentInternalServerError) Code() int {
	return 500
}

func (o *PostPaymentInstrumentInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentInternalServerError %s", 500, payload)
}

func (o *PostPaymentInstrumentInternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tms/v1/paymentinstruments][%d] postPaymentInstrumentInternalServerError %s", 500, payload)
}
...
func (o *PostPaymentInstrumentBody) contextValidateType(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentRequest"+"."+"type", "body", string(o.Type)); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentConflictBody post payment instrument conflict body
swagger:model PostPaymentInstrumentConflictBody
*/
type PostPaymentInstrumentConflictBody struct {

	// errors
	// Read Only: true
	Errors []*PostPaymentInstrumentConflictBodyErrorsItems0 `json:"errors"`
}

// Validate validates this post payment instrument conflict body
func (o *PostPaymentInstrumentConflictBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostPaymentInstrumentConflictBody) validateErrors(formats strfmt.Registry) error {
	if swag.IsZero(o.Errors) { // not required
		return nil
	}
	...
	for i := 0; i < len(o.Errors); i++ {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("postPaymentInstrumentConflict" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("postPaymentInstrumentConflict" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this post payment instrument conflict body based on the context it is used
func (o *PostPaymentInstrumentConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PostPaymentInstrumentConflictBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentConflict"+"."+"errors", "body", []*PostPaymentInstrumentConflictBodyErrorsItems0(o.Errors)); err != nil {
		return err
	}
...
// MarshalBinary interface implementation
func (o *PostPaymentInstrumentConflictBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *PostPaymentInstrumentConflictBody) UnmarshalBinary(b []byte) error {
	var res PostPaymentInstrumentConflictBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
PostPaymentInstrumentConflictBodyErrorsItems0 post payment instrument conflict body errors items0
swagger:model PostPaymentInstrumentConflictBodyErrorsItems0
*/
type PostPaymentInstrumentConflictBodyErrorsItems0 struct {
...
// Validate validates this post payment instrument conflict body errors items0
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this post payment instrument conflict body errors items0 based on the context it is used
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) contextValidateMessage(ctx context.Context, formats strfmt.Registry) error {
...
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *PostPaymentInstrumentConflictBodyErrorsItems0) UnmarshalBinary(b []byte) error {
	var res PostPaymentInstrumentConflictBodyErrorsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *PostPaymentInstrumentCreatedBody) contextValidateType(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentCreated"+"."+"type", "body", string(o.Type)); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentCreatedBodyCard) validateHash(formats strfmt.Registry) error {
	if swag.IsZero(o.Hash) { // not required
		return nil
	}

	if err := validate.MinLength("postPaymentInstrumentCreated"+"."+"card"+"."+"hash", "body", o.Hash, 32); err != nil {
		return err
	}

	if err := validate.MaxLength("postPaymentInstrumentCreated"+"."+"card"+"."+"hash", "body", o.Hash, 34); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentCreatedBodyCard) contextValidateHash(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentCreated"+"."+"card"+"."+"hash", "body", string(o.Hash)); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentCreatedBodyEmbedded Additional resources for the Payment Instrument.
//
...
/*
PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifier tmsEmbeddedInstrumentIdentifier
...
type PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifier struct {
	...
	TokenProvisioningInformation *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation `json:"tokenProvisioningInformation,omitempty"`
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifier) validateTokenProvisioningInformation(formats strfmt.Registry) error {
	...
	if o.TokenProvisioningInformation != nil {
		if err := o.TokenProvisioningInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("postPaymentInstrumentCreated" + "." + "_embedded" + "." + "instrumentIdentifier" + "." + "tokenProvisioningInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("postPaymentInstrumentCreated" + "." + "_embedded" + "." + "instrumentIdentifier" + "." + "tokenProvisioningInformation")
			}
			return err
		}
	}
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifier) contextValidateTokenProvisioningInformation(ctx context.Context, formats strfmt.Registry) error {
...
/*
PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierBillTo This information is sent to the issuer as part of network token enrollment and is not stored under the Instrument Identifier.
//
...
/*
PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierCard The expirationMonth, expirationYear and securityCode is sent to the issuer as part of network token enrollment and is not stored under the Instrument Identifier.
//
...
/*
PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierProcessingInformationAuthorizationOptions tmsAuthorizationOptions
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction) validateOriginalAuthorizedAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.OriginalAuthorizedAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("postPaymentInstrumentCreated"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"processingInformation"+"."+"authorizationOptions"+"."+"initiator"+"."+"merchantInitiatedTransaction"+"."+"originalAuthorizedAmount", "body", o.OriginalAuthorizedAmount, 15); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation post payment instrument created body embedded instrument identifier token provisioning information
swagger:model PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation
*/
type PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation struct {
...
// Validate validates this post payment instrument created body embedded instrument identifier token provisioning information
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this post payment instrument created body embedded instrument identifier token provisioning information based on context it is used
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) UnmarshalBinary(b []byte) error {
	var res PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateEnrollmentID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentCreated"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"enrollmentId", "body", string(o.EnrollmentID)); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateReason(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentCreated"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"reason", "body", string(o.Reason)); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentCreatedBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateTokenReferenceID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentCreated"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"tokenReferenceId", "body", string(o.TokenReferenceID)); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentCreatedBodyProcessingInformation tmsPaymentInstrumentProcessingInfo
...
func (o *PostPaymentInstrumentParamsBodyCard) validateHash(formats strfmt.Registry) error {
	if swag.IsZero(o.Hash) { // not required
		return nil
	}

	if err := validate.MinLength("postPaymentInstrumentRequest"+"."+"card"+"."+"hash", "body", o.Hash, 32); err != nil {
		return err
	}

	if err := validate.MaxLength("postPaymentInstrumentRequest"+"."+"card"+"."+"hash", "body", o.Hash, 34); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentParamsBodyCard) contextValidateHash(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentRequest"+"."+"card"+"."+"hash", "body", string(o.Hash)); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentParamsBodyEmbedded Additional resources for the Payment Instrument.
//
...
/*
PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifier tmsEmbeddedInstrumentIdentifier
...
type PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifier struct {
	...
	// token provisioning information
	TokenProvisioningInformation *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation `json:"tokenProvisioningInformation,omitempty"`
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifier) validateTokenProvisioningInformation(formats strfmt.Registry) error {
	if swag.IsZero(o.TokenProvisioningInformation) { // not required
		return nil
	}
	...
	if o.TokenProvisioningInformation != nil {
		if err := o.TokenProvisioningInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("postPaymentInstrumentRequest" + "." + "_embedded" + "." + "instrumentIdentifier" + "." + "tokenProvisioningInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("postPaymentInstrumentRequest" + "." + "_embedded" + "." + "instrumentIdentifier" + "." + "tokenProvisioningInformation")
			}
			return err
		}
	}
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifier) contextValidateTokenProvisioningInformation(ctx context.Context, formats strfmt.Registry) error {
...
/*
PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierBillTo This information is sent to the issuer as part of network token enrollment and is not stored under the Instrument Identifier.
//
...
/*
PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierCard The expirationMonth, expirationYear and securityCode is sent to the issuer as part of network token enrollment and is not stored under the Instrument Identifier.
//
...
/*
PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierProcessingInformationAuthorizationOptions tmsAuthorizationOptions
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction) validateOriginalAuthorizedAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.OriginalAuthorizedAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("postPaymentInstrumentRequest"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"processingInformation"+"."+"authorizationOptions"+"."+"initiator"+"."+"merchantInitiatedTransaction"+"."+"originalAuthorizedAmount", "body", o.OriginalAuthorizedAmount, 15); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation post payment instrument params body embedded instrument identifier token provisioning information
swagger:model PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation
*/
type PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation struct {
...
// Validate validates this post payment instrument params body embedded instrument identifier token provisioning information
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this post payment instrument params body embedded instrument identifier token provisioning information based on context it is used
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation) UnmarshalBinary(b []byte) error {
	var res PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenProvisioningInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateEnrollmentID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentRequest"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"enrollmentId", "body", string(o.EnrollmentID)); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateReason(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentRequest"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"reason", "body", string(o.Reason)); err != nil {
		return err
	}
...
func (o *PostPaymentInstrumentParamsBodyEmbeddedInstrumentIdentifierTokenizedCard) contextValidateTokenReferenceID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "postPaymentInstrumentRequest"+"."+"_embedded"+"."+"instrumentIdentifier"+"."+"tokenizedCard"+"."+"tokenReferenceId", "body", string(o.TokenReferenceID)); err != nil {
		return err
	}
...
/*
PostPaymentInstrumentParamsBodyProcessingInformation tmsPaymentInstrumentProcessingInfo
