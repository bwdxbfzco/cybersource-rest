...
// WithPaymentInstrumentID adds the paymentInstrumentID to the patch payment instrument params
func (o *PatchPaymentInstrumentParams) WithPaymentInstrumentID(paymentInstrumentID string) *PatchPaymentInstrumentParams {
	o.SetPaymentInstrumentID(paymentInstrumentID)
	return o
}

// SetPaymentInstrumentID adds the paymentInstrumentId to the patch payment instrument params
func (o *PatchPaymentInstrumentParams) SetPaymentInstrumentID(paymentInstrumentID string) {
