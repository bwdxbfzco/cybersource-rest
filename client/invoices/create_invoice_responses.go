...
func (o *CreateInvoiceCreated) Error() string {
	...
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceCreated %s", 201, payload)
}
...
// IsSuccess returns true when this create invoice accepted response has a 2xx status code
func (o *CreateInvoiceAccepted) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create invoice accepted response has a 3xx status code
func (o *CreateInvoiceAccepted) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create invoice accepted response has a 4xx status code
func (o *CreateInvoiceAccepted) IsClientError() bool {
	return false
}

// IsServerError returns true when this create invoice accepted response has a 5xx status code
func (o *CreateInvoiceAccepted) IsServerError() bool {
	return false
}

// IsCode returns true when this create invoice accepted response a status code equal to that given
func (o *CreateInvoiceAccepted) IsCode(code int) bool {
	return code == 202
}

// Code gets the status code for the create invoice accepted response
func (o *CreateInvoiceAccepted) Code() int {
	return 202
}

func (o *CreateInvoiceAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceAccepted %s", 202, payload)
}

func (o *CreateInvoiceAccepted) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceAccepted %s", 202, payload)
}
...
func (o *CreateInvoiceBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceBadRequest %s", 400, payload)
}
...
// IsSuccess returns true when this create invoice not found response has a 2xx status code
func (o *CreateInvoiceNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create invoice not found response has a 3xx status code
func (o *CreateInvoiceNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create invoice not found response has a 4xx status code
func (o *CreateInvoiceNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this create invoice not found response has a 5xx status code
func (o *CreateInvoiceNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this create invoice not found response a status code equal to that given
func (o *CreateInvoiceNotFound) IsCode(code int) bool {
	return code == 404
}

// Code gets the status code for the create invoice not found response
func (o *CreateInvoiceNotFound) Code() int {
	return 404
}

func (o *CreateInvoiceNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceNotFound %s", 404, payload)
}

func (o *CreateInvoiceNotFound) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoiceNotFound %s", 404, payload)
}
...
func (o *CreateInvoiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /invoicing/v2/invoices][%d] createInvoice default %s", o._statusCode, payload)
}
...
// Example: {"customerInformation":{"company":{"name":"ABC"},"email":"tanya.lee@my-email.world","merchantCustomerId":"1234","name":"Tanya Lee"},"invoiceInformation":{"allowPartialPayments":true,"deliveryMode":"email","description":"This is a test invoice","dueDate":"2019-07-11","sendImmediately":true},"orderInformation":{"amountDetails":{"currency":"USD","discountAmount":"126.08","discountPercent":"5.0","freight":{"amount":"20.00","taxable":true},"minimumPartialAmount":"20","subAmount":"2749.72","taxDetails":{"amount":"208.04","rate":"8.25","type":"State Tax"},"totalAmount":"2623.64"},"lineItems":[{"discountAmount":"13.04","discountPercent":"5.0","productName":"First line item's name","productSku":"P653727383","quantity":"20","taxAmount":"0.0","taxRate":"0.0","totalAmount":"247.86","unitPrice":"12.05"}]}}
...
type CreateInvoiceCreatedBodyCustomerInformation struct {
	...
	// company
	Company *CreateInvoiceCreatedBodyCustomerInformationCompany `json:"company,omitempty"`
...
func (o *CreateInvoiceCreatedBodyCustomerInformation) validateCompany(formats strfmt.Registry) error {
	...
	if o.Company != nil {
		if err := o.Company.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createInvoiceCreated" + "." + "customerInformation" + "." + "company")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createInvoiceCreated" + "." + "customerInformation" + "." + "company")
			}
			return err
		}
	}
...
// ContextValidate validate this create invoice created body customer information based on the context it is used
...
func (o *CreateInvoiceCreatedBodyCustomerInformation) contextValidateCompany(ctx context.Context, formats strfmt.Registry) error {
...
/*
CreateInvoiceCreatedBodyCustomerInformationCompany create invoice created body customer information company
swagger:model CreateInvoiceCreatedBodyCustomerInformationCompany
*/
type CreateInvoiceCreatedBodyCustomerInformationCompany struct {
...
// Validate validates this create invoice created body customer information company
func (o *CreateInvoiceCreatedBodyCustomerInformationCompany) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateInvoiceCreatedBodyCustomerInformationCompany) validateName(formats strfmt.Registry) error {
	if swag.IsZero(o.Name) { // not required
		return nil
	}

	if err := validate.MaxLength("createInvoiceCreated"+"."+"customerInformation"+"."+"company"+"."+"name", "body", o.Name, 60); err != nil {
		return err
	}
...
// ContextValidate validates this create invoice created body customer information company based on context it is used
func (o *CreateInvoiceCreatedBodyCustomerInformationCompany) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateInvoiceCreatedBodyCustomerInformationCompany) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateInvoiceCreatedBodyCustomerInformationCompany) UnmarshalBinary(b []byte) error {
	var res CreateInvoiceCreatedBodyCustomerInformationCompany
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateInvoiceCreatedBodyOrderInformationAmountDetailsFreight) validateTaxRate(formats strfmt.Registry) error {
	if swag.IsZero(o.TaxRate) { // not required
		return nil
	}

	if err := validate.MaxLength("createInvoiceCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"freight"+"."+"taxRate", "body", o.TaxRate, 7); err != nil {
		return err
	}
...
func (o *CreateInvoiceCreatedBodyOrderInformationLineItemsItems0) validateDiscountAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.DiscountAmount) { // not required
		return nil
	}
...
func (o *CreateInvoiceCreatedBodyOrderInformationLineItemsItems0) validateDiscountRate(formats strfmt.Registry) error {
...
func (o *CreateInvoiceCreatedBodyOrderInformationLineItemsItems0) validateTaxAmount(formats strfmt.Registry) error {
...
func (o *CreateInvoiceCreatedBodyOrderInformationLineItemsItems0) validateTaxRate(formats strfmt.Registry) error {
	if swag.IsZero(o.TaxRate) { // not required
		return nil
	}
...
func (o *CreateInvoiceCreatedBodyOrderInformationLineItemsItems0) validateTotalAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TotalAmount) { // not required
		return nil
	}
...
type CreateInvoiceParamsBodyCustomerInformation struct {
	...
	// company
	Company *CreateInvoiceParamsBodyCustomerInformationCompany `json:"company,omitempty"`
...
func (o *CreateInvoiceParamsBodyCustomerInformation) validateCompany(formats strfmt.Registry) error {
	if swag.IsZero(o.Company) { // not required
		return nil
	}
	...
	if o.Company != nil {
		if err := o.Company.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("createInvoiceRequest" + "." + "customerInformation" + "." + "company")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("createInvoiceRequest" + "." + "customerInformation" + "." + "company")
			}
			return err
		}
	}
...
// ContextValidate validate this create invoice params body customer information based on the context it is used
...
func (o *CreateInvoiceParamsBodyCustomerInformation) contextValidateCompany(ctx context.Context, formats strfmt.Registry) error {
...
/*
CreateInvoiceParamsBodyCustomerInformationCompany create invoice params body customer information company
swagger:model CreateInvoiceParamsBodyCustomerInformationCompany
*/
type CreateInvoiceParamsBodyCustomerInformationCompany struct {
...
// Validate validates this create invoice params body customer information company
func (o *CreateInvoiceParamsBodyCustomerInformationCompany) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CreateInvoiceParamsBodyCustomerInformationCompany) validateName(formats strfmt.Registry) error {
	if swag.IsZero(o.Name) { // not required
		return nil
	}

	if err := validate.MaxLength("createInvoiceRequest"+"."+"customerInformation"+"."+"company"+"."+"name", "body", o.Name, 60); err != nil {
		return err
	}
...
// ContextValidate validates this create invoice params body customer information company based on context it is used
func (o *CreateInvoiceParamsBodyCustomerInformationCompany) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateInvoiceParamsBodyCustomerInformationCompany) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateInvoiceParamsBodyCustomerInformationCompany) UnmarshalBinary(b []byte) error {
	var res CreateInvoiceParamsBodyCustomerInformationCompany
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *CreateInvoiceParamsBodyOrderInformationAmountDetailsFreight) validateTaxRate(formats strfmt.Registry) error {
	if swag.IsZero(o.TaxRate) { // not required
		return nil
	}

	if err := validate.MaxLength("createInvoiceRequest"+"."+"orderInformation"+"."+"amountDetails"+"."+"freight"+"."+"taxRate", "body", o.TaxRate, 7); err != nil {
		return err
	}
...
func (o *CreateInvoiceParamsBodyOrderInformationLineItemsItems0) validateDiscountAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.DiscountAmount) { // not required
		return nil
	}
...
func (o *CreateInvoiceParamsBodyOrderInformationLineItemsItems0) validateDiscountRate(formats strfmt.Registry) error {
	if swag.IsZero(o.DiscountRate) { // not required
		return nil
	}
...
func (o *CreateInvoiceParamsBodyOrderInformationLineItemsItems0) validateTaxAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TaxAmount) { // not required
		return nil
	}
...
func (o *CreateInvoiceParamsBodyOrderInformationLineItemsItems0) validateTaxRate(formats strfmt.Registry) error {
	if swag.IsZero(o.TaxRate) { // not required
		return nil
	}
...
func (o *CreateInvoiceParamsBodyOrderInformationLineItemsItems0) validateTotalAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TotalAmount) { // not required
		return nil
	}
