...
type RefundPaymentParams struct {
	...
	*/
	...
	RefundPaymentRequest RefundPaymentBody
...
// WithID adds the id to the refund payment params
func (o *RefundPaymentParams) WithID(id string) *RefundPaymentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the refund payment params
func (o *RefundPaymentParams) SetID(id string) {
	o.ID = id
}

// WithRefundPaymentRequest adds the refundPaymentRequest to the refund payment params
func (o *RefundPaymentParams) WithRefundPaymentRequest(refundPaymentRequest RefundPaymentBody) *RefundPaymentParams {
	o.SetRefundPaymentRequest(refundPaymentRequest)
	return o
}

// SetRefundPaymentRequest adds the refundPaymentRequest to the refund payment params
func (o *RefundPaymentParams) SetRefundPaymentRequest(refundPaymentRequest RefundPaymentBody) {
	o.RefundPaymentRequest = refundPaymentRequest
}
...
func (o *RefundPaymentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetBodyParam(o.RefundPaymentRequest); err != nil {
		return err
	}
