...
func (o *RefundPaymentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /pts/v2/payments/{id}/refunds] refundPayment", response, response.Code())
	}
}
...
func (o *RefundPaymentCreated) Error() string {
	...
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/refunds][%d] refundPaymentCreated %s", 201, payload)
}
...
func (o *RefundPaymentBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/refunds][%d] refundPaymentBadRequest %s", 400, payload)
}
...
func (o *RefundPaymentBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/refunds][%d] refundPaymentBadGateway %s", 502, payload)
}
...
type RefundPaymentCreatedBodyClientReferenceInformation struct {
	...
	ReturnReconciliationID string `json:"returnReconciliationId,omitempty"`
...
type RefundPaymentCreatedBodyOrderInformation struct {
	...
	// amount details
	AmountDetails *RefundPaymentCreatedBodyOrderInformationAmountDetails `json:"amountDetails,omitempty"`
...
func (o *RefundPaymentCreatedBodyOrderInformation) validateAmountDetails(formats strfmt.Registry) error {
	...
	if o.AmountDetails != nil {
		if err := o.AmountDetails.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("refundPaymentCreated" + "." + "orderInformation" + "." + "amountDetails")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("refundPaymentCreated" + "." + "orderInformation" + "." + "amountDetails")
			}
			return err
		}
	}
...
func (o *RefundPaymentCreatedBodyOrderInformation) contextValidateAmountDetails(ctx context.Context, formats strfmt.Registry) error {
...
/*
RefundPaymentCreatedBodyOrderInformationAmountDetails refund payment created body order information amount details
swagger:model RefundPaymentCreatedBodyOrderInformationAmountDetails
*/
type RefundPaymentCreatedBodyOrderInformationAmountDetails struct {
...
// Validate validates this refund payment created body order information amount details
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) validateExchangeRate(formats strfmt.Registry) error {
	if swag.IsZero(o.ExchangeRate) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"exchangeRate", "body", o.ExchangeRate, 13); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) validateForeignAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.ForeignAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"foreignAmount", "body", o.ForeignAmount, 15); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) validateForeignCurrency(formats strfmt.Registry) error {
	if swag.IsZero(o.ForeignCurrency) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"foreignCurrency", "body", o.ForeignCurrency, 5); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) validateSettlementAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"settlementAmount", "body", o.SettlementAmount, 12); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) validateSettlementCurrency(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementCurrency) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"orderInformation"+"."+"amountDetails"+"."+"settlementCurrency", "body", o.SettlementCurrency, 3); err != nil {
		return err
	}
...
// ContextValidate validates this refund payment created body order information amount details based on context it is used
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RefundPaymentCreatedBodyOrderInformationAmountDetails) UnmarshalBinary(b []byte) error {
	var res RefundPaymentCreatedBodyOrderInformationAmountDetails
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *RefundPaymentCreatedBodyProcessorInformation) validateApprovalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ApprovalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"processorInformation"+"."+"approvalCode", "body", o.ApprovalCode, 6); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyProcessorInformation) validateSettlementDate(formats strfmt.Registry) error {
	if swag.IsZero(o.SettlementDate) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"processorInformation"+"."+"settlementDate", "body", o.SettlementDate, 4); err != nil {
		return err
	}
...
func (o *RefundPaymentCreatedBodyRefundAmountDetails) validateCreditAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.CreditAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentCreated"+"."+"refundAmountDetails"+"."+"creditAmount", "body", o.CreditAmount, 15); err != nil {
		return err
	}
...
type RefundPaymentParamsBodyBuyerInformation struct {
	...
	PersonalIdentification []*RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0 `json:"personalIdentification"`
...
func (o *RefundPaymentParamsBodyBuyerInformation) validateDateOfBirth(formats strfmt.Registry) error {
	if swag.IsZero(o.DateOfBirth) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"buyerInformation"+"."+"dateOfBirth", "body", o.DateOfBirth, 8); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyBuyerInformation) validateGender(formats strfmt.Registry) error {
	if swag.IsZero(o.Gender) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"buyerInformation"+"."+"gender", "body", o.Gender, 3); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyBuyerInformation) validateLanguage(formats strfmt.Registry) error {
	if swag.IsZero(o.Language) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"buyerInformation"+"."+"language", "body", o.Language, 2); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyBuyerInformation) validatePersonalIdentification(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.PersonalIdentification); i++ {
		...
		if o.PersonalIdentification[i] != nil {
			if err := o.PersonalIdentification[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("refundPaymentRequest" + "." + "buyerInformation" + "." + "personalIdentification" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("refundPaymentRequest" + "." + "buyerInformation" + "." + "personalIdentification" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this refund payment params body buyer information based on the context it is used
...
func (o *RefundPaymentParamsBodyBuyerInformation) contextValidatePersonalIdentification(ctx context.Context, formats strfmt.Registry) error {
...
/*
RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0 refund payment params body buyer information personal identification items0
swagger:model RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0
*/
type RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0 struct {
...
// Validate validates this refund payment params body buyer information personal identification items0
func (o *RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0) validateID(formats strfmt.Registry) error {
	if swag.IsZero(o.ID) { // not required
		return nil
	}
...
// ContextValidate validates this refund payment params body buyer information personal identification items0 based on context it is used
func (o *RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0) UnmarshalBinary(b []byte) error {
	var res RefundPaymentParamsBodyBuyerInformationPersonalIdentificationItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *RefundPaymentParamsBodyClientReferenceInformation) validateReconciliationID(formats strfmt.Registry) error {
	if swag.IsZero(o.ReconciliationID) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"clientReferenceInformation"+"."+"reconciliationId", "body", o.ReconciliationID, 60); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyMerchantInformationMerchantDescriptor) validateCountryOfOrigin(formats strfmt.Registry) error {
	if swag.IsZero(o.CountryOfOrigin) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"countryOfOrigin", "body", o.CountryOfOrigin, 2); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyMerchantInformationMerchantDescriptor) validateCustomerServicePhoneNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.CustomerServicePhoneNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"customerServicePhoneNumber", "body", o.CustomerServicePhoneNumber, 27); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyMerchantInformationMerchantDescriptor) validateStoreID(formats strfmt.Registry) error {
	if swag.IsZero(o.StoreID) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"storeId", "body", o.StoreID, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyMerchantInformationMerchantDescriptor) validateStoreName(formats strfmt.Registry) error {
	if swag.IsZero(o.StoreName) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"merchantInformation"+"."+"merchantDescriptor"+"."+"storeName", "body", o.StoreName, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationBillTo) validateCounty(formats strfmt.Registry) error {
	if swag.IsZero(o.County) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"billTo"+"."+"county", "body", o.County, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationBillTo) validateDistrict(formats strfmt.Registry) error {
	if swag.IsZero(o.District) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"billTo"+"."+"district", "body", o.District, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationBillTo) validateMiddleName(formats strfmt.Registry) error {
	if swag.IsZero(o.MiddleName) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"billTo"+"."+"middleName", "body", o.MiddleName, 60); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationBillTo) validateTitle(formats strfmt.Registry) error {
	if swag.IsZero(o.Title) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"billTo"+"."+"title", "body", o.Title, 60); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationShipTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"administrativeArea", "body", o.AdministrativeArea, 20); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationShipTo) validateCounty(formats strfmt.Registry) error {
	if swag.IsZero(o.County) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"county", "body", o.County, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyOrderInformationShipTo) validateEmail(formats strfmt.Registry) error {
	if swag.IsZero(o.Email) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"email", "body", o.Email, 255); err != nil {
		return err
	}
...
type RefundPaymentParamsBodyPaymentInformation struct {
	...
	// e wallet
	EWallet *RefundPaymentParamsBodyPaymentInformationEWallet `json:"eWallet,omitempty"`
...
func (o *RefundPaymentParamsBodyPaymentInformation) validateEWallet(formats strfmt.Registry) error {
	...
	if o.EWallet != nil {
		if err := o.EWallet.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("refundPaymentRequest" + "." + "paymentInformation" + "." + "eWallet")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("refundPaymentRequest" + "." + "paymentInformation" + "." + "eWallet")
			}
			return err
		}
	}
...
func (o *RefundPaymentParamsBodyPaymentInformation) contextValidateEWallet(ctx context.Context, formats strfmt.Registry) error {
...
func (o *RefundPaymentParamsBodyPaymentInformationCard) validateSecurityCode(formats strfmt.Registry) error {
	if swag.IsZero(o.SecurityCode) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"card"+"."+"securityCode", "body", o.SecurityCode, 4); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyPaymentInformationCard) validateUseAs(formats strfmt.Registry) error {
	if swag.IsZero(o.UseAs) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"card"+"."+"useAs", "body", o.UseAs, 20); err != nil {
		return err
	}
...
/*
RefundPaymentParamsBodyPaymentInformationEWallet refund payment params body payment information e wallet
swagger:model RefundPaymentParamsBodyPaymentInformationEWallet
*/
type RefundPaymentParamsBodyPaymentInformationEWallet struct {
...
// Validate validates this refund payment params body payment information e wallet
func (o *RefundPaymentParamsBodyPaymentInformationEWallet) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RefundPaymentParamsBodyPaymentInformationEWallet) validateFundingSource(formats strfmt.Registry) error {
	if swag.IsZero(o.FundingSource) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"eWallet"+"."+"fundingSource", "body", o.FundingSource, 30); err != nil {
		return err
	}
...
// ContextValidate validates this refund payment params body payment information e wallet based on context it is used
func (o *RefundPaymentParamsBodyPaymentInformationEWallet) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RefundPaymentParamsBodyPaymentInformationEWallet) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RefundPaymentParamsBodyPaymentInformationEWallet) UnmarshalBinary(b []byte) error {
	var res RefundPaymentParamsBodyPaymentInformationEWallet
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *RefundPaymentParamsBodyPaymentInformationFluidData) validateValue(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"fluidData"+"."+"value", "body", o.Value, 4000); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyPaymentInformationLegacyToken) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"legacyToken"+"."+"id", "body", o.ID, 1); err != nil {
		return err
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"legacyToken"+"."+"id", "body", o.ID, 32); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyPaymentInformationTokenizedCard) validateAssuranceMethod(formats strfmt.Registry) error {
	if swag.IsZero(o.AssuranceMethod) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"assuranceMethod", "body", o.AssuranceMethod, 2); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyPaymentInformationTokenizedCard) validateCryptogram(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"cryptogram", "body", o.Cryptogram, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyPaymentInformationTokenizedCard) validateSecurityCodeIndicator(formats strfmt.Registry) error {
	if swag.IsZero(o.SecurityCodeIndicator) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"paymentInformation"+"."+"tokenizedCard"+"."+"securityCodeIndicator", "body", o.SecurityCodeIndicator, 1); err != nil {
		return err
	}
...
type RefundPaymentParamsBodyProcessingInformation struct {
	...
	// refund options
	RefundOptions *RefundPaymentParamsBodyProcessingInformationRefundOptions `json:"refundOptions,omitempty"`
...
func (o *RefundPaymentParamsBodyProcessingInformation) validateRefundOptions(formats strfmt.Registry) error {
	...
	if o.RefundOptions != nil {
		if err := o.RefundOptions.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("refundPaymentRequest" + "." + "processingInformation" + "." + "refundOptions")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("refundPaymentRequest" + "." + "processingInformation" + "." + "refundOptions")
			}
			return err
		}
	}
...
func (o *RefundPaymentParamsBodyProcessingInformation) contextValidateRefundOptions(ctx context.Context, formats strfmt.Registry) error {
...
/*
RefundPaymentParamsBodyProcessingInformationRefundOptions refund payment params body processing information refund options
swagger:model RefundPaymentParamsBodyProcessingInformationRefundOptions
*/
type RefundPaymentParamsBodyProcessingInformationRefundOptions struct {

	// The reason for the refund.
	Reason string `json:"reason,omitempty"`
}

// Validate validates this refund payment params body processing information refund options
func (o *RefundPaymentParamsBodyProcessingInformationRefundOptions) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this refund payment params body processing information refund options based on context it is used
func (o *RefundPaymentParamsBodyProcessingInformationRefundOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RefundPaymentParamsBodyProcessingInformationRefundOptions) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RefundPaymentParamsBodyProcessingInformationRefundOptions) UnmarshalBinary(b []byte) error {
	var res RefundPaymentParamsBodyProcessingInformationRefundOptions
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
type RefundPaymentParamsBodyTravelInformation struct {
	...
	// vehicle data
	VehicleData *RefundPaymentParamsBodyTravelInformationVehicleData `json:"vehicleData,omitempty"`
}
...
func (o *RefundPaymentParamsBodyTravelInformation) validateVehicleData(formats strfmt.Registry) error {
	...
	if o.VehicleData != nil {
		if err := o.VehicleData.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("refundPaymentRequest" + "." + "travelInformation" + "." + "vehicleData")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("refundPaymentRequest" + "." + "travelInformation" + "." + "vehicleData")
			}
			return err
		}
	}
...
func (o *RefundPaymentParamsBodyTravelInformation) contextValidateVehicleData(ctx context.Context, formats strfmt.Registry) error {
...
func (o *RefundPaymentParamsBodyTravelInformationAutoRental) validateAffiliateName(formats strfmt.Registry) error {
	if swag.IsZero(o.AffiliateName) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"affiliateName", "body", o.AffiliateName, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationAutoRental) validateCompanyName(formats strfmt.Registry) error {
	if swag.IsZero(o.CompanyName) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"companyName", "body", o.CompanyName, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationAutoRentalRentalAddress) validatePostalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.PostalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"rentalAddress"+"."+"postalCode", "body", o.PostalCode, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationAutoRentalReturnAddress) validateAddress1(formats strfmt.Registry) error {
	if swag.IsZero(o.Address1) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"returnAddress"+"."+"address1", "body", o.Address1, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationAutoRentalReturnAddress) validatePostalCode(formats strfmt.Registry) error {
	if swag.IsZero(o.PostalCode) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"autoRental"+"."+"returnAddress"+"."+"postalCode", "body", o.PostalCode, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationLodging) validateName(formats strfmt.Registry) error {
	if swag.IsZero(o.Name) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"lodging"+"."+"name", "body", o.Name, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateFlightType(formats strfmt.Registry) error {
	if swag.IsZero(o.FlightType) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"flightType", "body", o.FlightType, 2); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateFrequentFlyerNumber(formats strfmt.Registry) error {
	if swag.IsZero(o.FrequentFlyerNumber) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"frequentFlyerNumber", "body", o.FrequentFlyerNumber, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateInsuranceAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.InsuranceAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"insuranceAmount", "body", o.InsuranceAmount, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateIsDomestic(formats strfmt.Registry) error {
	if swag.IsZero(o.IsDomestic) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"isDomestic", "body", o.IsDomestic, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validatePassengerType(formats strfmt.Registry) error {
	if swag.IsZero(o.PassengerType) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"passengerType", "body", o.PassengerType, 50); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateReservationSystemCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"reservationSystemCode", "body", o.ReservationSystemCode, 20); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateThirdPartyStatus(formats strfmt.Registry) error {
	if swag.IsZero(o.ThirdPartyStatus) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"thirdPartyStatus", "body", o.ThirdPartyStatus, 255); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationTransitAirline) validateTotalInsuranceAmount(formats strfmt.Registry) error {
	if swag.IsZero(o.TotalInsuranceAmount) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"transit"+"."+"airline"+"."+"totalInsuranceAmount", "body", o.TotalInsuranceAmount, 50); err != nil {
		return err
	}
...
/*
RefundPaymentParamsBodyTravelInformationVehicleData refund payment params body travel information vehicle data
swagger:model RefundPaymentParamsBodyTravelInformationVehicleData
*/
type RefundPaymentParamsBodyTravelInformationVehicleData struct {
...
// Validate validates this refund payment params body travel information vehicle data
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) validateChargingReasonCode(formats strfmt.Registry) error {
	if swag.IsZero(o.ChargingReasonCode) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"vehicleData"+"."+"chargingReasonCode", "body", o.ChargingReasonCode, 3); err != nil {
		return err
	}
...
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) validateConnectorType(formats strfmt.Registry) error {
	if swag.IsZero(o.ConnectorType) { // not required
		return nil
	}

	if err := validate.MaxLength("refundPaymentRequest"+"."+"travelInformation"+"."+"vehicleData"+"."+"connectorType", "body", o.ConnectorType, 3); err != nil {
		return err
	}
...
// ContextValidate validates this refund payment params body travel information vehicle data based on context it is used
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RefundPaymentParamsBodyTravelInformationVehicleData) UnmarshalBinary(b []byte) error {
	var res RefundPaymentParamsBodyTravelInformationVehicleData
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
