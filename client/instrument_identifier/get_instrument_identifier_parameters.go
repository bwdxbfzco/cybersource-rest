...
// WithInstrumentIdentifierID adds the instrumentIdentifierID to the get instrument identifier params
func (o *GetInstrumentIdentifierParams) WithInstrumentIdentifierID(instrumentIdentifierID string) *GetInstrumentIdentifierParams {
	o.SetInstrumentIdentifierID(instrumentIdentifierID)
	return o
}

// SetInstrumentIdentifierID adds the instrumentIdentifierId to the get instrument identifier params
func (o *GetInstrumentIdentifierParams) SetInstrumentIdentifierID(instrumentIdentifierID string) {
