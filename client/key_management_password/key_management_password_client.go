...
// New creates a new key management password API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new key management password API client with basic auth credentials.
...
// New creates a new key management password API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for key management password API
*/
type Client struct {
...
/*
UpdatePassword activates or de activate password
...
func (a *Client) UpdatePassword(params *UpdatePasswordParams, opts ...ClientOption) (*UpdatePasswordOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "UpdatePassword",
		Method:             "PATCH",
		PathPattern:        "/kms/v2/keys-password/{keyId}",
