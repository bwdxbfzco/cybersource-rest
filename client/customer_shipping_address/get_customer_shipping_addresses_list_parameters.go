...
// WithCustomerID adds the customerID to the get customer shipping addresses list params
func (o *GetCustomerShippingAddressesListParams) WithCustomerID(customerID string) *GetCustomerShippingAddressesListParams {
	o.SetCustomerID(customerID)
	return o
}

// SetCustomerID adds the customerId to the get customer shipping addresses list params
func (o *GetCustomerShippingAddressesListParams) SetCustomerID(customerID string) {
