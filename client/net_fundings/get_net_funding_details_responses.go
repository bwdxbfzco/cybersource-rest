...
func (o *GetNetFundingDetailsOK) Error() string {
	...
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsOK %s", 200, payload)
}
...
func (o *GetNetFundingDetailsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsBadRequest %s", 400, payload)
}
...
func (o *GetNetFundingDetailsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsUnauthorized %s", 401, payload)
}
...
func (o *GetNetFundingDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsForbidden %s", 403, payload)
}
...
func (o *GetNetFundingDetailsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsNotFound %s", 404, payload)
}
...
func (o *GetNetFundingDetailsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /reporting/v3/net-fundings][%d] getNetFundingDetailsInternalServerError %s", 500, payload)
}
