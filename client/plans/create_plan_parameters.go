...
type CreatePlanParams struct {
	...
	// CreatePlanRequest.
	CreatePlanRequest CreatePlanBody
...
// WithCreatePlanRequest adds the createPlanRequest to the create plan params
func (o *CreatePlanParams) WithCreatePlanRequest(createPlanRequest CreatePlanBody) *CreatePlanParams {
	o.SetCreatePlanRequest(createPlanRequest)
	return o
}

// SetCreatePlanRequest adds the createPlanRequest to the create plan params
func (o *CreatePlanParams) SetCreatePlanRequest(createPlanRequest CreatePlanBody) {
	o.CreatePlanRequest = createPlanRequest
}
...
func (o *CreatePlanParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if err := r.SetBodyParam(o.CreatePlanRequest); err != nil {
		return err
	}
