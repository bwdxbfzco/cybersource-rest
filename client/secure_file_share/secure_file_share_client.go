...
// New creates a new secure file share API client with basic auth credentials.
...
// New creates a new secure file share API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
// WithContentTypeStarStarCharsetUTF8 sets the Content-Type header to "*/*;charset=utf-8".
func WithContentTypeStarStarCharsetUTF8(r *runtime.ClientOperation) {
...
func (a *Client) GetFile(params *GetFileParams, opts ...ClientOption) (*GetFileOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		ProducesMediaTypes: []string{"application/xml", "text/csv", "application/pdf"},
		ConsumesMediaTypes: []string{"*/*;charset=utf-8"},
