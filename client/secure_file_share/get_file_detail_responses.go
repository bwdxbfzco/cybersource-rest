...
func (o *GetFileDetailOK) Error() string {
	...
	return fmt.Sprintf("[GET /sfs/v1/file-details][%d] getFileDetailOK %s", 200, payload)
}
...
func (o *GetFileDetailBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /sfs/v1/file-details][%d] getFileDetailBadRequest %s", 400, payload)
}
...
func (o *GetFileDetailUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /sfs/v1/file-details][%d] getFileDetailUnauthorized %s", 401, payload)
}
...
func (o *GetFileDetailNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /sfs/v1/file-details][%d] getFileDetailNotFound %s", 404, payload)
}
...
func (o *GetFileDetailInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /sfs/v1/file-details][%d] getFileDetailInternalServerError %s", 500, payload)
}
