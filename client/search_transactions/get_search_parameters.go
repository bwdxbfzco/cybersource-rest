...
// WithSearchID adds the searchID to the get search params
func (o *GetSearchParams) WithSearchID(searchID string) *GetSearchParams {
	o.SetSearchID(searchID)
	return o
}

// SetSearchID adds the searchId to the get search params
func (o *GetSearchParams) SetSearchID(searchID string) {
	o.SearchID = searchID
}
