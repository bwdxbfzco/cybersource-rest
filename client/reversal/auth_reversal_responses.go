...
func (o *AuthReversalCreated) Error() string {
	...
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/reversals][%d] authReversalCreated %s", 201, payload)
}
...
func (o *AuthReversalBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/reversals][%d] authReversalBadRequest %s", 400, payload)
}
...
func (o *AuthReversalBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /pts/v2/payments/{id}/reversals][%d] authReversalBadGateway %s", 502, payload)
}
...
type AuthReversalBody struct {
	...
	// payment information
	PaymentInformation *AuthReversalParamsBodyPaymentInformation `json:"paymentInformation,omitempty"`
	...
	ProcessorInformation *AuthReversalParamsBodyProcessorInformation `json:"processorInformation,omitempty"`
...
func (o *AuthReversalBody) validatePaymentInformation(formats strfmt.Registry) error {
	...
	if o.PaymentInformation != nil {
		if err := o.PaymentInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("authReversalRequest" + "." + "paymentInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("authReversalRequest" + "." + "paymentInformation")
			}
			return err
		}
	}
...
func (o *AuthReversalBody) validateProcessorInformation(formats strfmt.Registry) error {
	...
	if o.ProcessorInformation != nil {
		if err := o.ProcessorInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("authReversalRequest" + "." + "processorInformation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("authReversalRequest" + "." + "processorInformation")
			}
			return err
		}
	}
...
func (o *AuthReversalBody) contextValidatePaymentInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *AuthReversalBody) contextValidateProcessorInformation(ctx context.Context, formats strfmt.Registry) error {
...
func (o *AuthReversalCreatedBodyProcessorInformation) validateResponseDetails(formats strfmt.Registry) error {
	if swag.IsZero(o.ResponseDetails) { // not required
		return nil
	}

	if err := validate.MaxLength("authReversalCreated"+"."+"processorInformation"+"."+"responseDetails", "body", o.ResponseDetails, 255); err != nil {
		return err
	}
...
func (o *AuthReversalParamsBodyClientReferenceInformation) validateReconciliationID(formats strfmt.Registry) error {
	if swag.IsZero(o.ReconciliationID) { // not required
		return nil
	}

	if err := validate.MaxLength("authReversalRequest"+"."+"clientReferenceInformation"+"."+"reconciliationId", "body", o.ReconciliationID, 60); err != nil {
		return err
	}
...
func (o *AuthReversalParamsBodyClientReferenceInformation) validateTransactionID(formats strfmt.Registry) error {
	if swag.IsZero(o.TransactionID) { // not required
		return nil
	}

	if err := validate.MaxLength("authReversalRequest"+"."+"clientReferenceInformation"+"."+"transactionId", "body", o.TransactionID, 30); err != nil {
		return err
	}
...
/*
AuthReversalParamsBodyPaymentInformation auth reversal params body payment information
swagger:model AuthReversalParamsBodyPaymentInformation
*/
type AuthReversalParamsBodyPaymentInformation struct {

	// payment type
	PaymentType *AuthReversalParamsBodyPaymentInformationPaymentType `json:"paymentType,omitempty"`
}

// Validate validates this auth reversal params body payment information
func (o *AuthReversalParamsBodyPaymentInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *AuthReversalParamsBodyPaymentInformation) validatePaymentType(formats strfmt.Registry) error {
	...
	if o.PaymentType != nil {
		if err := o.PaymentType.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("authReversalRequest" + "." + "paymentInformation" + "." + "paymentType")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("authReversalRequest" + "." + "paymentInformation" + "." + "paymentType")
			}
			return err
		}
	}
...
// ContextValidate validate this auth reversal params body payment information based on the context it is used
func (o *AuthReversalParamsBodyPaymentInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *AuthReversalParamsBodyPaymentInformation) contextValidatePaymentType(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformation) UnmarshalBinary(b []byte) error {
	var res AuthReversalParamsBodyPaymentInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
AuthReversalParamsBodyPaymentInformationPaymentType auth reversal params body payment information payment type
swagger:model AuthReversalParamsBodyPaymentInformationPaymentType
*/
type AuthReversalParamsBodyPaymentInformationPaymentType struct {

	// method
	Method *AuthReversalParamsBodyPaymentInformationPaymentTypeMethod `json:"method,omitempty"`
}

// Validate validates this auth reversal params body payment information payment type
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) validateMethod(formats strfmt.Registry) error {
	...
	if o.Method != nil {
		if err := o.Method.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("authReversalRequest" + "." + "paymentInformation" + "." + "paymentType" + "." + "method")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("authReversalRequest" + "." + "paymentInformation" + "." + "paymentType" + "." + "method")
			}
			return err
		}
	}
...
// ContextValidate validate this auth reversal params body payment information payment type based on the context it is used
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) contextValidateMethod(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformationPaymentType) UnmarshalBinary(b []byte) error {
	var res AuthReversalParamsBodyPaymentInformationPaymentType
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
AuthReversalParamsBodyPaymentInformationPaymentTypeMethod auth reversal params body payment information payment type method
swagger:model AuthReversalParamsBodyPaymentInformationPaymentTypeMethod
*/
type AuthReversalParamsBodyPaymentInformationPaymentTypeMethod struct {
...
// Validate validates this auth reversal params body payment information payment type method
func (o *AuthReversalParamsBodyPaymentInformationPaymentTypeMethod) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this auth reversal params body payment information payment type method based on context it is used
func (o *AuthReversalParamsBodyPaymentInformationPaymentTypeMethod) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformationPaymentTypeMethod) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AuthReversalParamsBodyPaymentInformationPaymentTypeMethod) UnmarshalBinary(b []byte) error {
	var res AuthReversalParamsBodyPaymentInformationPaymentTypeMethod
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
AuthReversalParamsBodyProcessorInformation auth reversal params body processor information
swagger:model AuthReversalParamsBodyProcessorInformation
*/
type AuthReversalParamsBodyProcessorInformation struct {
...
// Validate validates this auth reversal params body processor information
func (o *AuthReversalParamsBodyProcessorInformation) Validate(formats strfmt.Registry) error {
	var res []error

	if err := o.validatePreApprovalToken(formats); err != nil {
		res = append(res, err)
	}
...
func (o *AuthReversalParamsBodyProcessorInformation) validatePreApprovalToken(formats strfmt.Registry) error {
	if swag.IsZero(o.PreApprovalToken) { // not required
		return nil
	}

	if err := validate.MaxLength("authReversalRequest"+"."+"processorInformation"+"."+"preApprovalToken", "body", o.PreApprovalToken, 60); err != nil {
		return err
	}
...
// ContextValidate validates this auth reversal params body processor information based on context it is used
func (o *AuthReversalParamsBodyProcessorInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *AuthReversalParamsBodyProcessorInformation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AuthReversalParamsBodyProcessorInformation) UnmarshalBinary(b []byte) error {
	var res AuthReversalParamsBodyProcessorInformation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
