...
AuthReversalParams contains all the parameters to send to the API endpoint
	...
	for the auth reversal operation.
...
// WithDefaults hydrates default values in the auth reversal params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AuthReversalParams) WithDefaults() *AuthReversalParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the auth reversal params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AuthReversalParams) SetDefaults() {
