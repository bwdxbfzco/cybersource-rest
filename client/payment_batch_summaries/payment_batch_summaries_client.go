...
// New creates a new payment batch summaries API client with basic auth credentials.
...
// New creates a new payment batch summaries API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
type ClientService interface {
	GetPaymentBatchSummary(params *GetPaymentBatchSummaryParams, opts ...ClientOption) (*GetPaymentBatchSummaryOK, error)
...
*/
func (a *Client) GetPaymentBatchSummary(params *GetPaymentBatchSummaryParams, opts ...ClientOption) (*GetPaymentBatchSummaryOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		ProducesMediaTypes: []string{"application/hal+json", "text/csv", "application/xml"},
