...
// WithTaxRequest adds the taxRequest to the calculate tax params
func (o *CalculateTaxParams) WithTaxRequest(taxRequest CalculateTaxBody) *CalculateTaxParams {
	o.SetTaxRequest(taxRequest)
	return o
}

// SetTaxRequest adds the taxRequest to the calculate tax params
func (o *CalculateTaxParams) SetTaxRequest(taxRequest CalculateTaxBody) {
	o.TaxRequest = taxRequest
}
...
func (o *CalculateTaxParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if err := r.SetBodyParam(o.TaxRequest); err != nil {
		return err
	}
